...
@section('content')
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Blocklist Certificate Logs</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Blocklist Certificate Logs</h5>
        ...
        <table class="table">
          ...
          <thead>
            <tr>
              ...
              <th scope="col">Blocklisted Recipient</th>
              <th scope="col">Options</th>

            </tr>
          </thead>
          <tbody>
            @foreach($black_logs as $data)
            <tr>
              <th scope="row">{{ $data->blacklogs_id}}</th>
              <td>{{ $data->Date}}</td>
              <td>{{ $data->ulast.", ".$data->ufirst." ".$data->umid}}</td>
              <td>{{ $data->elast.", ".$data->efirst." ".$data->emid." ".$data->esuff}}</td>
