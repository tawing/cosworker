...
@section('content')
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
       ...
       <!-- End Deactivated -->
       <li class="nav-item">
          <a class="nav-link active" href="{{ url('/blacklist') }}">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body parent" >
                  <h5 class="card-title">Blacklisted Employees</h5>

                  <a href="{{ url('/blacklist-pdf')}}"><button  type="button" class="btn btn-outline-info mb-4"><i class="bi bi-printer" style="padding-right: 5px;"></i>Print</button></a>
                    ...
                    <tbody>
                      ...
                      <th>{{ $data->employee_id}}</th>
                        ...
                        <td><span class="badge bg-danger">
                            @if($data->blacklist_id === 1) Blacklisted
                            @endif
                        </td>
                        <td><span class="badge bg-danger">
                                @if($data->blacklist_id === 1) Awol
                                @elseif($data->blacklist_id === 2) Deceased @endif
                            </span>
                        </td>
                        <td >
                        <a href="{{ route('employee.profile', ['id' => $data->employee_id]) }}">
